<template>
    <n-modal v-model:visible="visible" title="Generate Patient" @ok="handleOk" @cancel="handleCancel">
  ...
  const rules = {
    ...
    alexa_id: { required: true, message: 'Alexa ID is required', trigger: 'blur' },
    medical_history: { required: true, message: 'Medical History is required', trigger: 'blur' },
    medication: { required: true, message: 'Medication is required', trigger: 'blur' }
  };
