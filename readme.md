...
`For the colors, the numbers are fine. Note that there could be fields that only have red/yellow/green/grey (no blue) and maybe one or two fields that only have blue/grey but no red. That depends on the priority of this symptom or category.`
| column      | type          | description                                          |
| ----------- | ------------- | ---------------------------------------------------- |
| id          | uint          |                                                      |
| patient_id  | uint          |                                                      |
...
| notes               | string       | notes that can be edited by the user       `TBD: maybe we will need time stamps and multiple note entries`                  |
